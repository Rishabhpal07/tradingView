...
import { getNews } from "@/lib/actions/finnhub";
...
export const sendSignUpEmail = inngest.createFunction(
    ...
    async ({ event, step }) => {
        ...
        await step.run('send-welcome-email', async () => {
            ...
            const introText = (part && 'text' in part ? part.text : null) ||'Thanks for joining trading view. You now have the tools to track markets and make smarter moves.'
